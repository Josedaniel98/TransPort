...
export default reduxForm({
    form: 'inventarioModalForm', // a unique identifier for this form
    validate: (data) => {
        return validate(data, {
            producto: validators.exists()('Este campo es requerido'),
            existencias: validators.exists()('Este campo es requerido'),
        });
    },
})(InventarioModal);